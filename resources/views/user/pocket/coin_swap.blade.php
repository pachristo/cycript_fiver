            ...
            <div class="card cp-user-custom-card">
                <div class="card-body">
                    <div class="cp-user-card-header-area">
                        <h4>{{__('Einzahlung über Exchange Partner ')}}</h4>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card cp-user-custom-card">
                <div class="card-body">
                    <div class="cp-user-card-header-area">
                                     ...
                                     <h5><span style="color: #ffffff;">Um Ihnen die Teilnahme an unserem Programm so einfach wie nur m&ouml;glich zu machen, bieten wir Ihnen die M&ouml;glichkeit Ihr Konto bei uns indirekt zu kapitalisieren. </span><br /><br /><span style="color: #ffffff;">ADV Cash </span><br /><br /><span style="color: #ffffff;">ADV Cash ist ein bew&auml;hrter Dienstleister f&uuml;r online Zahlungen und Sie k&ouml;nnen Ihr Konto dort bequem via Bank , Kreditkarte und vielen anderen Optionen kapitalisieren. Sobald Ihr Guthaben gebucht ist , k&ouml;nnen Sie es uns intern senden. Wir buchen Ihr Guthaben dann manuell bei uns ein. </span><br /><br /><span style="color: #ffffff;">Link : <a href="https://advcash.com/en/" target="_blank" rel="noopener" style="color: #ffff00;">https://advcash.com/en/ </a></span><br /><br /><span style="color: #ffffff;">Bitnovo Voucher </span><br /><br /><span style="color: #ffffff;">Alternativ akzeptieren wir auch Bitnovo Voucher f&uuml;r die Kapitalisierung Ihres Kontos bei uns. </span><br /><br /><span style="color: #ffffff;">Bitnovo Voucher k&ouml;nnen Sie hier ohne extra Verifizierung mit wenigen Mausklicks bekommen : <a href="https://www.guthaben.de/bitnovo" target="_blank" rel="noopener" style="color: #ffff00;">https://www.guthaben.de/bitnovo </a></span><br /><br /><span style="color: #ffffff;">Guthaben.de akzeptiert Zahlungen via PayPal, Sofort&uuml;berweisung, Kreditkarte und weiteren Optionen. Die Auslieferung der Voucher ( Codes) erfolgt in Echtzeit an Ihre Email Adresse. </span><br /><br /><span style="color: #ffffff;">Ihre Voucher k&ouml;nnen Sie dann an uns per Email senden und wir buchen Ihr Guthaben manuell ein. </span><br /><br /><span style="color: #ffffff;">Wenn Sie Ihr Konto &uuml;ber ADV Cash oder Bitnovo Voucher kapitalisieren wollen, kontaktieren Sie bitte unseren Support f&uuml;r weitere Infos und Zahlungsdaten. </span><br /><br /><br /></h5>
