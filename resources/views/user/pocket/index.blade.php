                ...
                <div class="card-body">
                    <div class="cp-user-card-header-area">
                        <div class="cp-user-title">
                            <h4>{{__('Mein Wallet')}}</h4>
                        </div>
                        <div class="buttons">
                            <button class="btn cp-user-add-pocket" data-toggle="modal"
                                    data-target="#add-pocket">{{__('Wallet hinzufügen')}}</button>
                                ...
                                <div class="cp-user-wallet-table table-responsive">
                                    <table class="table table-borderless cp-user-custom-table" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="all">{{__('Typ')}}</th>
                                            <th class="desktop">{{__('Stand')}}</th>
                                            <th class="desktop">{{__('Stand Empfehlungen')}}</th>
                                            <th class="desktop">{{__('aktualisiert am')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if(isset($wallets[0]))
