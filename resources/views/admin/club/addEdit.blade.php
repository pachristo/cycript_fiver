                    ...
                    <form action="{{route('planSave')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12  mt-20">
                                <div class="form-group">
                                    <label for="#">{{__('Plan Fees Method')}}</label>
                            ...
                            <div class="col-lg-6 col-12  mt-20">
                                <div class="form-group">
                                    <label for="#">{{__('Plan bonus coin type')}}</label>
                                    <small>{{__('Select coin type which coin you want to give bonus')}}</small>
                                    <select class="form-control" name="bonus_coin_type">
                                        @if(isset($coins[0]))
                                            @foreach($coins as $coin)
                                                <option value="{{$coin->type}}" @if($item->bonus_coin_type == $coin->type) selected @endif >{{$coin->type}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
